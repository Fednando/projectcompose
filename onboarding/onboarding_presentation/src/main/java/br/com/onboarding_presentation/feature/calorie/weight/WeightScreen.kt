package br.com.onboarding_presentation.feature.calorie.weight
...
import br.com.onboarding_presentation.feature.calorie.components.UnitTextField
...
fun WeightScreen(
    ...
    LaunchedEffect(key1 = true) {
        viewModel.uiEvent.collect { event ->
            when (event) {
                is UiEvent.Navigate -> onNavigationToActivity()
