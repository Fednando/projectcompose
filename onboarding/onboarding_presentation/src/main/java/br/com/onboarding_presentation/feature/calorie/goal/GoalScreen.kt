package br.com.onboarding_presentation.feature.calorie.goal
...
import br.com.onboarding_presentation.feature.calorie.components.SelectableButton
...
fun GoalScreen(
    ...
    LaunchedEffect(key1 = true) {
        viewModel.uiEvent.collect { event ->
            when (event) {
                is UiEvent.Navigate -> onNavigationToNutrientGoal()
                else -> Unit
            }
        }
    }
